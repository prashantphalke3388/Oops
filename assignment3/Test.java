...
public class Test 
{
  public static void main(String[] args) 
  {
	  ...
	  Branch   b1 = new Branch(1001,"SBI","Satara" );
	  ...
	  Branch   b3 = new Branch(1003,"BOM","Pune" );
	  System.out.println("------details of brnach b3--------------------");
	  System.out.println(b3);
	  
	System.out.println("=========customer details================");	
	
	Customer c1 = new Customer(101,30001,"prashant", "satara","15/11/91","12/12/21", b1);
	System.out.println("=---details of customer c1---------------------------------------");
	System.out.println(c1);
	
	Customer c2 = new Customer(102,30002,"prafulla", "parbhani","07/07/96","01/12/22", b2);
	System.out.println("=---details of customer c2---------------------------------------------");
	System.out.println(c2);
	
	Customer c3 = new Customer(103,30002,"Nikhil", "chandrapur","05/03/95","01/02/20", b3);
	...
	Customer_Account_Statement ca1 = new Customer_Account_Statement();
