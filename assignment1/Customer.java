	...
	void InitializePerson()
	   {
		System.out.println("----------Initializing Person using super in Customer -----------");
		   ...
		   super.setPname("Prashant");      System.out.println("Person Name    = "+super.getPname());
		   super.setPaddress("Satara");  System.out.println("Person address = "+super.getPaddress());
		   super.setDob(1997);           System.out.println("Person DOB     = "+super.getDob());
	   }
